...
#SBATCH -t 12:00:00
#SBATCH -A lt200394
#SBATCH -J mmeb_clipkd-released-ViT-B-16-teacher-laion400m_image
...
export OUTPUT_PATH="/project/lt200394-thllmV/benchmark/VLM2Vec/results/clipkd-released-ViT-B-16-teacher-laion400m/image/"
export DATA_BASEDIR="data/vlm2vec_eval"

cd "/project/lt200394-thllmV/benchmark/VLM2Vec"
bash "/project/lt200394-thllmV/benchmark/VLM2Vec/scripts/run_mmeb_clipkd-released-ViT-B-16-teacher-laion400m_image.sh"
