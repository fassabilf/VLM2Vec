...
export OUTPUT_PATH="/project/lt200394-thllmV/benchmark/VLM2Vec/results/MetaCLIP2-worldwide-huge-quickgelu/image/"

bash ./scripts/run_mmebv1_metaclip2_image.sh
