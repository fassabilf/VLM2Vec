...
#SBATCH -t 12:00:00
#SBATCH -A lt200394
#SBATCH -J mmebv1_visdoc_metaclip2
...
export OUTPUT_PATH="/project/lt200394-thllmV/benchmark/VLM2Vec/results/MetaCLIP2-worldwide-huge-quickgelu/visdoc/"

bash ./scripts/run_mmebv1_metaclip2_visdoc.sh
