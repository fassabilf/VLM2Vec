...
#SBATCH -t 12:00:00
#SBATCH -A lt200394
#SBATCH -J mmebv1_student_visdoc
...
export OUTPUT_PATH="/project/lt200394-thllmV/benchmark/VLM2Vec/results/clipkd-ViT-T-16-cc12m/visdoc/"

bash ./scripts/run_mmebv1_student_visdoc.sh
