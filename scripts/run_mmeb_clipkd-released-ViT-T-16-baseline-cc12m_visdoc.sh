...
MODEL_NAME="fassabilf/clipkd-released-ViT-T-16-baseline-cc12m"
MODEL_BACKBONE="openclip"
OUTPUT_PATH="${OUTPUT_PATH:-/project/lt200394-thllmV/benchmark/VLM2Vec/results/clipkd-released-ViT-T-16-baseline-cc12m/visdoc/}"
