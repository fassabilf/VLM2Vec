...
MODEL_NAME="fassabilf/clipkd-released-ViT-B-16-teacher-laion400m"
MODEL_BACKBONE="openclip"
OUTPUT_PATH="${OUTPUT_PATH:-/project/lt200394-thllmV/benchmark/VLM2Vec/results/clipkd-released-ViT-B-16-teacher-laion400m/visdoc/}"
