...
export OUTPUT_PATH="/project/lt200394-thllmV/benchmark/VLM2Vec/results/CLIP-ViT-B-32-laion2B-s34B-b79K/image/"

bash ./scripts/run_mmebv1_teacher_image.sh
