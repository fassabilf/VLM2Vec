...
#SBATCH -t 12:00:00
#SBATCH -A lt200394
#SBATCH -J mmebv1_visdoc_openclip
...
export OUTPUT_PATH="/project/lt200394-thllmV/benchmark/VLM2Vec/results/DFN2B-CLIP-ViT-B-16/visdoc/"

bash ./scripts/run_mmebv1_openclip_visdoc.sh
