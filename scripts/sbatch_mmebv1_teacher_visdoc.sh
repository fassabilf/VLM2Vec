...
#SBATCH -t 12:00:00
#SBATCH -A lt200394
#SBATCH -J mmebv1_teacher_visdoc
...
export OUTPUT_PATH="/project/lt200394-thllmV/benchmark/VLM2Vec/results/CLIP-ViT-B-32-laion2B-s34B-b79K/visdoc/"

bash ./scripts/run_mmebv1_teacher_visdoc.sh
