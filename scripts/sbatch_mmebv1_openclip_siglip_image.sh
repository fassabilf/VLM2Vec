...
#SBATCH -t 12:00:00
#SBATCH -A lt200394
#SBATCH -J mmebv1_img_openclip_siglip
...
export OUTPUT_PATH="/project/lt200394-thllmV/benchmark/VLM2Vec/results/ViT-SO400M-14-SigLIP/image/"

bash ./scripts/run_mmebv1_openclip_siglip_image.sh